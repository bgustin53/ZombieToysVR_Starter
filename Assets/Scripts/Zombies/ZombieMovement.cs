...
public class ZombieMovement : MonoBehaviour
{
	...
	private float originalSpeed;                                            //Original movement speed of the enemy (in case they get frozen)
	private bool isRunningAway;                                             //Is the enemy running away?
	private Vector3 runAwayPosition;                                        //Where the enemy runs if they are hit with a stink attack
