...
public class HealingBeam : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (timeSinceEffectStarted >= effectDuration)
		{
			...
			// Deactivate GameObject after particles finish
			ParticleSystem particles = GetComponent<ParticleSystem>();
			if (particles != null)
			{
				StartCoroutine(DeactivateAfterParticles(particles));
			}
		}
		else 
	...
	IEnumerator DeactivateAfterParticles(ParticleSystem particles)
	{
